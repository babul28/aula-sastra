<div>
    <div class="grid xl:grid-cols-2 gap-4">
        ...
        <a href="{{ route('news.show', $item->uuid) }}"
            class="flex flex-col md:items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100">
            ...
            <div class="flex flex-col justify-between p-4 leading-normal">
                ...
                <p class="line-clamp-4 mb-3 font-normal text-gray-700">
                    {{ $item->description }}
                </p>
            </div>
        </a>
