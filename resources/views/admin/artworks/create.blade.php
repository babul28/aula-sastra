<x-admin-layout name="Create Artwork">
    <div class="container px-6 mx-auto grid">
        <div class="flex my-6 align-items-center">
            ...
            <div>
                <x-button type="button"
                    onclick="event.preventDefault(); document.getElementById('create-artwork-form').submit();"
        ...
        <form id="create-artwork-form" method="POST" action="{{ route('admin.artworks.store') }}"
            ...
            <div class="grid xl:grid-cols-4 gap-8">
                ...
                <div class="">
                    ...
                    <livewire:admin.artworks.slug-field />
