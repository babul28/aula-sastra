<x-admin-layout title="Dashboard">
    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            <x-admin.cards.analytic title="Total News" count="12836726" color="orange">
                <x-slot name="icon">
                    <x-icons.newspaper class="h-5 w-5" />
                </x-slot>
            </x-admin.cards.analytic>

            <x-admin.cards.analytic title="Total Artworks" count="8127631526" color="green">
                <x-slot name="icon">
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Submitted User</th>
