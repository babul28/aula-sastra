<x-admin-layout name="Create News">
    <div class="container px-6 mx-auto grid">
        <div class="flex my-6 align-items-center">
            ...
            <div>
                <x-button type="button"
                    onclick="event.preventDefault(); document.getElementById('create-news-form').submit();"
        ...
        <form id="create-news-form" method="POST" action="{{ route('admin.news.store') }}"
            ...
            <div class="grid xl:grid-cols-4 gap-8">
                <div class="xl:col-span-3">
                    <div x-data="" class="mb-5">
                        ...
                        <x-input @input="Livewire.emit('updatingTitle', $event.target.value)" type="text" name="title"
                            id="title" class="w-full" value="{{ old('title') }}" />
                ...
                <div class="">
                    ...
                    <livewire:admin.news.slug-field />
