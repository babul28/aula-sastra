<x-admin-layout title="Edit {{ $news->title }}">
    ...
    <div class="container px-6 mx-auto grid">
        <div class="flex my-6 align-items-center">
            ...
            <div>
                <x-button type="button"
                    onclick="event.preventDefault(); document.getElementById('update-news-form').submit();"
        ...
        <form id="update-news-form" method="POST" action="{{ route('admin.news.update', $news->uuid) }}"
                ...
                <div class="xl:col-span-3">
                    <div x-data="" class="mb-5">
                        ...
                        <x-input @input="Livewire.emit('updatingTitle', $event.target.value)" type="text" name="title"
                            id="title" class="w-full" value="{{ old('title', $news->title) }}" />
                ...
                <div class="">
                    ...
                    <div class="mb-5">
                        ...
                        <x-input type="text" class="w-full" name="type" id="type" readonly
                            value="{{ App\Enums\PostTypeEnum::NEWS }}" />
                    </div>

                    <livewire:admin.news.slug-field :slug="$news->slug" />
                    ...
                    <div x-data="{ featureImageName: `{{ $news->getFirstMedia('featured_image')->name }}`, featureImagePreview: `{{ $news->getFirstMedia('featured_image')->getUrl('thumbnail') }}` }"
                        class="mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <x-input type="text" class="w-full" name="meta[title]" id="meta.title"
                            value="{{ old('meta.title', $news->meta['title']) }}"
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="meta[description]" id="meta.description"
                            ...
                            rows="5">{{ old('meta.description', $news->meta['description']) }}</textarea>
